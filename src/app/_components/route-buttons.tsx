...
export const HomePageButton = () => {
  return (
    <Link href="/" as="/">
      <Button className="border bg-white text-indigo-500 shadow-sm hover:bg-indigo-500 hover:text-white focus-visible:outline-indigo-500 active:bg-indigo-600">
...
export const LoginPageButton = () => {
  return (
    <Link href="/dashboard" as="/dashboard">
      <Button className="border bg-indigo-400 text-white shadow-sm hover:bg-indigo-900 focus-visible:outline-indigo-500 active:bg-indigo-600">
