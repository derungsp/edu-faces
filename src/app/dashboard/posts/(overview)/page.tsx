  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gray-50 py-8">
      <div className="flex flex-col items-start justify-center gap-3">
        ...
        <div className="flex flex-col items-center justify-center gap-8 rounded-lg border bg-white px-4 py-8 shadow-sm lg:w-[600px]">
          ...
          <div className="flex items-center justify-start gap-4 rounded-lg border border-indigo-100 px-3 py-1 shadow-sm">
            <CreatePageButton />
            <span className="text-sm text-indigo-950">Add new post</span>
          </div>
      ...
      {posts.map((post) => (
        ...
        >
          <div className="flex w-full flex-col items-start justify-center gap-3 border-b border-indigo-100 pb-4">
            <h1 className="text-xl font-bold text-indigo-950">{post.title}</h1>
            <p className="text-lg text-indigo-950">{post.content}</p>
          </div>
